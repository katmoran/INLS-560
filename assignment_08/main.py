import sys # don't use quit() or exit() in a production code. use sys. exit 
...
# process user input 
    ...
    # enter a search term this // is a global website
    ...
    # Next check to see if the search_variable is in the content buffer: 
        ...
        if see_entries.lower() == 'y':
            print(f'Here are all the of the entries with the term {search_variable}:')
            with open(file_variable, 'r') as file:
                for line in file: 
